...
class Kayttajansarja extends BaseModel {
    ...
    public function __construct($attributes) {
        ...
        $this->validators = array('validate_episodesseen', 'validate_grade', 'validate_added');
    }
    ...
    public function validate_added() {
        $errors = array();
        if ($this->added == null) {
            $errors[] = 'Lisäyspäivä ei saa olla tyhjä!';
        }
        if (strlen($this->added) < 10) {
            $errors[] = 'Anna päivämäärä muodossa YYYY-MM-DD';
        }
